...
void form1(){
output(-9,8,"GRAPHICAL  IMPLEMENTATION OF 3x3 RUBIX CUBE");
output(-3,5,"Submitted by");
output(-17,3,"PRAJODH PRAGATH");
output(-4,3,"RAKSHITH A GOWDA");
output(8,3,"PRATHAM H SUNNAL");
output(-17,2,"(1BY19CS104)");
output(-4,2,"(1BY19CS114)");
output(8,2,"(1BY19CS109)");
output(-6,-1,"VIth SEM COMPUTER SCIENCE DEPT.");
output(-5.8,-2,"BMS INSTITUTE OF TECHNOLOGY");
output(-5,-3,"YELAHANKA, BANGALORE");
output(-3,-5,"Under the guidance of");
output(-17,-6,"Mr. MUNESHWAR.M.S");
output(-16,-7,"(Asst.Prof)");
output(8,-6,"Mrs.Chetana C");
output(9,-7,"(Asst.Prof)");
output(6,-9,"press ------> 0 to continue");
...
output(-15,8,"NAVIGATION OPTIONS");
output(-15,6,"1.Introduction");
output(-15,4,"2.Instructions");
output(-15,2,"3.Demo");
output(-15,0,"4.Exit");
...
output(-15,8,"INTRODUCTION");
output(-15,6,"This project is to implement a 3X3 rubik cube puzzle");
output(-15,5,"it provides all the basic fuctionalities of a traditional rubik cube. ");
output(-15,4,"a rubix cube has 6 faces each colored with a different color and 27 individual pieces");
output(-15,3,"we allow the users to move the faces of the cube and even increase the rotation speed ");
output(-15,2,"we also added an option where the users can backtrack their moves");
output(-15,1,"more info about how to use the puzzle is given in instructions menu");
output(5,-8,"press ------> 0 to go back");
...
output(-15,8,"INSTRUCTION");
output(-15,6,"-->use the keys ‘a’,’s’,’d’,’f’,’g’,’h’ to rotate the faces of the accordingly in the clockwise direction and the keys");
output(-14,5,"‘q’,’w’,’e’,’r’,’t’,’y’ to rotate in the anti-clockwise direction");
output(-15,4,"-->use the keys ‘1’,’2’,’4’,’5’,’6’,’8’,’9’ are used to move the viewer along the axis.");
output(-15,3,"-->use the keys ‘m’ and ‘n’ to alter the value of the rotation meter which controls the speed of the rotation");
output(-15,2,"-->use the key ‘o’ for the automatic solving of the cube");
output(5,-8,"press ------> 0 to go back");
